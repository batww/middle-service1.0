...
public class InvoiceQBOServiceImp implements IInvoiceQBOService, IQBOService {
    ...
    public Object createInvoiceFromEstimate(Estimate entity) throws FMSException, IOException {
        Invoice invoice = new Invoice();
        final String idOrder = String.valueOf(entity.getDocNumber());
        invoice.setDocNumber(idOrder);
        ...
        linkedTxn.setTxnId(entity.getId());
        linkedTxn.setTxnLineId(entity.getDocNumber());
        ...
        invoice.setCustomerRef(entity.getCustomerRef());
...
//        }
        ...
        invoice.setLine(entity.getLine());
